...
?>
    <div data-barba="container" data-barba-namespace="agenda" data-bg="<?php echo $termColor; ?>" data-text-color="#fff"
        ...
        <main class="main main--agenda">
            <div class="filter-bar">
                <div class="filter-events">
                    ...
                    <div class="event-cat-list">
                        <ul>
                            <li><a href="<?php echo get_field('page_agenda', 'option')['url']; ?>" title="Tout">Tout</a>
                            </li>
                            <?php
                            $tmp_post = $post;
            ...
            $next_shows = get_next_show_two_months_by_terms($year_to_show, $month_to_show, $the_term->term_id);
            ...
            $last_show = get_last_show_by_term($the_term->term_id);
