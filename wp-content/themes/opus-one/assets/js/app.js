$(document).ready(function () {
    ...
    // Chargement ajax des prochaines représentations de la page agenda
    // var processing = false;
    // if ($('body').hasClass("page-template-page-agenda")) {
    //     $(window).scroll(function () {
    //         if ($(window).scrollTop() >= $(document).height() - $(window).height() - $('footer').height() + 152) {
    ...
    //                                 setTimeout(function () { btn.removeClass("open"); }, 500);
    //                             } else {
    ...
    //                         }
    //                         init_tooltip_sidebar(position, '.next-month .tooltip-sidebar');
    ...
    //     const misc = { "optin_nl": 1 }
    //     const email = subscriptionForm.elements["input_1"].value;
    //     const firstname = subscriptionForm.elements["input_15.3"].value;
    //     const lastname = subscriptionForm.elements["input_15.6"].value;
    //     const postcode = subscriptionForm.elements["input_16.5"].value;
    //     const country = subscriptionForm.elements["input_16.6"].value;
    //     pop = subscriptionForm.elements["input_33"].value;
    //     reggae = subscriptionForm.elements["input_34"].value;
    //     rock = subscriptionForm.elements["input_17"].value;
    //     hiphop = subscriptionForm.elements["input_19"].value;
    //     chanson = subscriptionForm.elements["input_20"].value;
    //     jazz = subscriptionForm.elements["input_21"].value;
    //     electro = subscriptionForm.elements["input_31"].value;
    //     folk = subscriptionForm.elements["input_40"].value;
    //     cine = subscriptionForm.elements["input_39"].value;
    //     commusicale = subscriptionForm.elements["input_42"].value;
    //     enfant = subscriptionForm.elements["input_25"].value;
    //     humour = subscriptionForm.elements["input_24"].value;
    //     expo = subscriptionForm.elements["input_26"].value;
    //     spectacle = subscriptionForm.elements["input_22"].value;
    //     sr = subscriptionForm.elements["input_47"].value;
    //     sa = subscriptionForm.elements["input_49"].value;
    //     const interest = [pop, reggae, rock, hiphop, chanson, jazz, electro, folk, cine, commusicale, enfant, humour, expo, spectacle, sr, sa];
    //     const xhr = new XMLHttpRequest();
    //     xhr.open("POST", endpoint);
    //     xhr.setRequestHeader("Content-Type", "application/json");
    ...
    //     window.location.href = "https://www.opus-one.ch/confirmation-inscription-newsletter/";
    //     return false;
    // }
