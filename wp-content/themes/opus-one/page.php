...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    <div data-barba="container" data-barba-namespace="page-special" data-bg="#6E32FF" data-text-color="#fff" data-logo-title="<?php the_title(); ?>">
        ...
        <main class="main main--page">
            ...
            <section class="section section--two-sides" id="booking">

                <div class="two-sides">
                    <div class="two-sides__side two-sides__side--left">
                        <h2 class="two-sides__title">Booking</h2>
                    </div>
                    <div class="two-sides__side two-sides__side--right">
                        <div class="two-side__content">
                            ...
                            <div class="block block--text">
                                <div>
                                    <p>Partenaire de nombreux clubs, théâtres et festivals, Opus One concrétise de nombreux concerts chaque année dans toute la Suisse.</p>
                                </div>
                            </div>
                            ...
                            <div class="block block--text">
                                <div>
                                    <div class="big-p">
                                        <p>On the road baby</p>
                                    </div>
                                    <p><a href="artists.html" title="" class="btn">Voir les artistes</a></p>
                                </div>
                            </div>
                                ...
                                <ul class="contact-list">
                                    <li class="contact-person">
                                        ...
                                        <div class="contact-person__side contact-person__side--img">
                                            <img src="assets/img/03.png" alt="Luc Patrick Vega">
                                            <div class="img" style="background-image: url(assets/img/03.png)"></div>
                                        </div>
