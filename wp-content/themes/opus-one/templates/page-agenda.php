...
?>
        <div data-barba="container" data-barba-namespace="agenda" data-bg="<?php echo $colorBackground; ?>" data-text-color="<?php echo $colorText; ?>" data-logo-title="Agenda">
            ...
            <main class="main main--agenda page-template-page-agenda">
                            ...
                            <ul>
                                ...
                                foreach ($terms as $term) {
                                    ...
                                    if (count($next_shows) != 0) { ?>
                                        <li><a href="<?= get_term_link($term, "taxonomy-types"); ?>" title="<?= $term->name; ?>"><?= $term->name; ?></a></li><?php
                                                                                                                                                                    }
                                                                                                                                                                }
                                                                                                                                                                        ?>
                            </ul>
                ...
                <div class="next_request" data-next-year="<?php echo substr($next, 0, 4); ?>" data-next-month="<?php echo substr($next, 4, 2); ?>" data-last-date="<?php echo substr($last_show, 0, 6); ?>"></div>
                    ...
                    <ul class="event-list"><?php
                            ...
                            <li class="event">
                                <div class="event__call-back event__call-back--mobile">
                                    <div class="double-buttons">
                                        <a href="single-event.html" class="double-bouttons__btn double-bouttons__btn--info" title=""><?= __('Informations') ?></a>
                                        <?php if (!empty($ticket_url)) { ?>
                                            <a href="<?php $ticket_url ?>" class="double-bouttons__btn double-bouttons__btn--ticket" title=""><?php __('Tickets') ?></a>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="event__bottom">
                                    ...
                                    <div class="event__call-back event__call-back--desktop">
                                        <div class="double-buttons">
                                            <a href="<?= $url ?>" class="double-bouttons__btn double-bouttons__btn--info" title="">
                                                <?php
                                                if ($nb_futur_show <= 1) {
                            ...
                            <?php
                                ...
                                <li class="event">
                                    <div class="event__call-back event__call-back--mobile">
                                        <div class="double-buttons">
                                            <a href="<?= get_permalink($post->ID); ?>" class="double-bouttons__btn double-bouttons__btn--info" title=""><?= __('Informations') ?></a>
                                            <?php if (!empty($ticket_url)) { ?>
                                                <a href="<?php $ticket_url ?>" class="double-bouttons__btn double-bouttons__btn--ticket" title=""><?php __('Tickets') ?></a>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="event__bottom">
                                        ...
                                        <div class="event__call-back event__call-back--desktop">
                                            <div class="double-buttons">
                                                <a href="<?= get_permalink($post->ID); ?>" class="double-bouttons__btn double-bouttons__btn--info" title="">
                                                    <?php
                                                    if ($nb_futur_show <= 1) {
                                                        _e("Informations", "opus-one");
                                                    } else {
